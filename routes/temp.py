    ...
    try:
        ...
        if _rollno and _deviceId and _temp:
            ...
            try:
                ...
                response = requests.post(f"https://api.telegram.org/bot{bot_token}/sendMessage?chat_id={chat_id}&text=Roll%20No:%20{_rollno}%0D%0ADevice%20ID:%20{_deviceId}%0D%0ATemperature:%20{_temp}")
